...
-- ----------------------------
INSERT INTO "public"."tbl_physical_count" VALUES (1, 'PC-0000001', '[{"id":"quezon_ave","name":"QUEZON AVE"}]', '2023-5-24', '2023-5-24', 'annual', '[]', 25, NULL, 'ongoing', 1, NULL, NULL, NULL, '2023-05-24 11:24:57+08', NULL, NULL, NULL, '[{"branch":"quezon_ave","type":"admin","employee":{"id":2,"name":"UY, AGUSTIN TAN"}}]');
...
-- ----------------------------
INSERT INTO "public"."tbl_physical_count_personnels" VALUES (2, NULL, 3, NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO "public"."tbl_physical_count_personnels" VALUES (1, 1, 2, 'quezon_ave', 'admin', 1, '2023-05-24 11:25:07', 1, 1);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."tbl_audit_trail_id_seq"', 35, true);
...
SELECT setval('"public"."tbl_items_id_seq"', 26, true);
...
SELECT setval('"public"."tbl_physical_count_personnels_id_seq"', 3, true);
...
SELECT setval('"public"."tbl_racks_id_seq"', 25, true);
