                    ...
                    list?.map((data, index) => (
                        <Stack direction= "row" justifyContent= "space-between" alignItems= "center" key= { index } sx= { item } spacing= { 2 }>
                            <Stack direction= "column" justifyContent= "flex-start" alignItems= "flex-start" sx= {{ flexGrow: 1, overflow: 'hidden' }}>
                                ...
                                <Typography variant= "caption" sx= { txt }>{ (data.created_by)?.toUpperCase() }</Typography>
                            ...
                            <Stack direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 2 }>
                                ...
                                <Stack direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 1 }>
                                    <Typography sx= { icons } component= { Link } to= { `/setup/module/form/update/${data.id}` }>
                                        <FontAwesomeIcon icon= { faPencil } size= "lg" />
                                    </Typography>
                                    <Typography sx= { icons } component= { Link } to= { `/setup/module/form/view/${data.id}` }>
