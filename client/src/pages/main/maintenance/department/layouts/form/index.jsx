...
const Index = () => {
    ...
    const { isFetching, refetch } =  useGet({ key: ['dpt_specific'], fetch: specific({ table: 'tbl_department', id: id ?? null }), options: { enabled: type !== 'new', refetchOnWindowFocus: false}, 
                                                        onSuccess: (data) => { 
    ...
    return (
        <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" sx= {{ width: '100%', height: '100%', paddingBottom: '20px' }} spacing= { 3 }>
            <Stack direction= "row" justifyContent= "space-between" alignItems= "center">
                ...
                <Typography sx= { btnicon } component= { Link } to= "/maintenance/department" ><FontAwesomeIcon icon= { faChevronLeft }/></Typography>
            </Stack>
