                    ...
                    <Stack direction= "row" justifyContent= "flex-start" alignItems= "center" key= { index } sx= { item } spacing= { 2 }>
                        ...
                        <Stack direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 2 }>
                            ...
                            <Stack direction= "row" justifyContent= "flex-start" alignItems= "center" spacing= { 1 }>
                                <Typography sx= { icons } component= { Link } to= { `/maintenance/department/form/update/${data.id}` }>
                                    <FontAwesomeIcon icon= { faPencil } size= "lg" />
                                </Typography>
                                <Typography sx= { icons } component= { Link } to= { `/maintenance/department/form/view/${data.id}` }>
