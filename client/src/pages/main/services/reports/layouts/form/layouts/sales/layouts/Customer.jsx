        ...
        <Grid container direction= "row" justifyContent= "flex-start" alignItems= "flex-start" spacing= { 1 }>
            <Grid item xs= { 12 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('customer') } name= "customer" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
            ...
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('project') } name= "project" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
            ...
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('so_no') } name= "so_no" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
            ...
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('service_location') } name= "service_location" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
            ...
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('po_no') } name= "po_no" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
                </Stack>
            </Grid>
            <Grid item xs= { 12 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('contact_person') } name= "contact_person" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
            ...
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('position') } name= "position" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
                </Stack>
            </Grid>
            <Grid item xs= { 12 } sm= { 6 }>
                <Stack direction= "column" justifyContent= "flex-start" alignContent= "stretch">
                    ...
                    { fetching ? <Skeleton variant= "rounded" height= "35px" /> :
                        <TextField { ...register('contact_number') } name= "contact_number" variant= "standard" InputProps= {{ disableUnderline: true }} sx= { input } disabled= { true } /> }
                </Stack>
            </Grid>
        </Grid>
    );
