...
const Index = () => {
    ...
    const { data: sub, isFetching } = useGet({ key: ['submodule'], fetch: submodule('evaluation'), options: { refetchOnWindowFocus: false } });
    ...
    return (
        <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" sx= {{ width: '100%', overflow: 'hidden' }} spacing= { 1 }>
            <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 1 }>
                <Typography variant= "h6" sx= {{ fontFamily: 'Boldstrom', color: '#535b64' }}>Evaluation</Typography>
                <Dashboard />
