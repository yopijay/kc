...
router.get('/excel/:table/:type', (req, res) => { query.excel(req.params.table, req.params.type).then(response => res.status(200).send(response)).catch(error => res.status(200).send(error)); });
